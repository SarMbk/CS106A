...
/** The maximum number of rolls one player can do in one turn */
	public static final int MAX_N_ROLLS = 3;
	
/** The score given for full house (25 points) */
	public static final int FULL_HOUSE_SCORE = 25;
	
/** The score given for yahtzee (50 points) */
	public static final int YAHTZEE_SCORE = 50;
	
/** The score given for small straight (30 points) */
	public static final int SMALL_STRAIGHT_SCORE = 30;
	
/** The score given for large straight (30 points) */
	public static final int LARGE_STRAIGHT_SCORE = 40;
	
/**	The total score for upper category required to get bonus points*/	
	public static final int UPPER_SCORE_FOR_BONUS = 63;
	
/** The amount of bonus points that a player gets if his/her total score for upper category is equal to UPPER_SCORE_FOR_BONUS or more*/	
