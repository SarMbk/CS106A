...
/** The string text that should appear in the Graph interactor button */
	public static final String GRAPH = "Graph";
	
/** The string text that should appear in the clear interactor button */
	public static final String CLR = "Clear";
	
/** The decade that the record started is 1900 */
	public static final int STARTING_DECADE = 1900;
