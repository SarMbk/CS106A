...
public interface FacePamphletConstants {
	...
	/** The x coordinate of the start of the friends list in the application window */
	public static final double FRIENDS_X_COORDINATE = APPLICATION_WIDTH/2.5;

	/** The y spacing between lines in the friends list */
	public static final double FRIENDS_Y_SPACING = 20;
